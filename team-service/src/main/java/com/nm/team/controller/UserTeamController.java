...
public class UserTeamController {
    ...
    @JsonView(Views.Public.class)
    public List<UserTeam> findTeamByMatchId(@QueryParam("mathcId") Integer matchId,@QueryParam("userId") Integer userId) {
        return userTeamService.findTeamByMatchId(matchId,userId);
    }

    @GetMapping("/update-team-point")
    public Map<String,String> updateUserTeamPoints(@QueryParam("matchId") Integer matchId) {
